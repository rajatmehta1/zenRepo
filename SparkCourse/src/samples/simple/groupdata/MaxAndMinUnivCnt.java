...
public class MaxAndMinUnivCnt implements Serializable{
	private static String appName = "Country with max university and countries with min";
	...
	public static void main(String[] args) {
		...
		Tuple2<String, Integer> cntryWithMaxUnivCnt = cntryGrpUnivCnt.max(new MaxComparator());
		
		System.out.println(cntryWithMaxUnivCnt._1 + " and university count is : " + cntryWithMaxUnivCnt._2);
